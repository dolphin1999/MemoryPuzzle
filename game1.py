...
WINDOWHEIGHT = 480 # size of windows height in ppixels
...
assert(BOARDWIDTH*BOARDHEIGHT)%2 == 0, 'there should be even number of boxes.'
...
def main():
       ...
       pygame.init()
       soundObj = pygame.mixer.Sound('button-17.wav')
